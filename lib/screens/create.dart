                  ...
                  children: <Widget>[
                    ...
                    Row(children: <Widget>[
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            pickerColor = Color(0xff8B008B);
                          });
                        },
                        child: Container(
                            height: 40, width: 40, color: Color(0xff8B008B)),
                      ),
                      GestureDetector(
                        onTap: () {
                          setState(() {
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                print("this should be form value ");
            ...
            onSaved: (value) {
              print("this is the text field input");
              print(value);
              setState(() {
                picName = value!;
              });
              ...
              onPressed: () {
                ...
                if (_formKey.currentState!.validate()) {
                  Future savePdf() async {
                    ...
                    print("this is the picName in the upload");
                    print(picName);
